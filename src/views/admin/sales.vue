  ...
  <div class="py-4 container-fluid">
    ...
    <div class="mt-4 row container-fluid" v-if="fcp_age_groups">
      ...
      <div class="col-sm-8  mt-lg-0 container-fluid" >
        <div class="card">
          <div class="card-body">
            <h5 class="font-weight-bolder">New sale</h5>
            <div class="row">
            ...
            <br><br>
            <h5>Weaning Details for in-house birth</h5><br>
            ...
            <div class="col-sm-6">
              ...
              <input type="checkbox"   name="vehicle1" value="Active">
      ...
      <div class="mt-4  mt-lg-0" >
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="font-weight-bolder">My sales </h5><br>
      ...
      <div  class="modal-dialog modal-lg modal-dialog-scrollable">
        ...
        <div class="modal-content" >
          <div class="card" >
            ...
            <div class="card-body">
              <h5 class="font-weight-bolder">Viewing sale</h5>
              <div class="row">
                <div class="col-12 col-sm-4">
                  <label>Tag No.</label>
                  <input
                      v-model="viewing_sale.tagNo"
                      class="form-control"
                      type="text"
                ...
                <div class="col-12 col-sm-4">
                  <label>Breed</label><br>
                  <select   v-model="viewing_sale.breed"  >
                    <option>Large white</option>
                    <option>Landrance</option>
                    <option>Duroc</option>
                    <option>Local</option>
                ...
                <div class="col-12 col-sm-4">
                  <label>Description</label>
                  <textarea class="form-control" type="text"
                            v-model="viewing_sale.description"
                ...
                <div class="col-12 col-sm-3">
                  <label class="mt-4">Color</label><br>
                  <select    v-model="viewing_sale.pig_color" >
                    <option>White</option>
                    <option>Brown</option>
                    <option>Black</option>
                    <option>Brown and black</option>
                ...
                <div class="col-3">
                  <label class="mt-4">Weight(KG)</label>
                  <input class="form-control" type="number"   v-model="viewing_sale.weight" />
                </div>
                <div class="col-12 col-sm-3">
                  <label class="mt-4">Origin</label><br>
                  <select    v-model="viewing_sale.origin" >
                    <option>In-house</option>
                    <option>Purchased</option>
                  </select>
                </div>
                ...
                <div class="col-3">
                  <label class="mt-4">Date of birth</label>
                  <input class="form-control" type="date"   v-model="viewing_sale.dob" />
                </div>
              ...
              <div class="row">
                <div class="col-12 col-sm-4">
                  <label>Weaning Date</label>
                  <input
                      v-model="viewing_sale.weaning_date"
                      class="form-control"
                      type="date"
                ...
                <div class="col-12 col-sm-4">
                  <label>Weaning weight</label><br>
                  <input
                      v-model="viewing_sale.weaning_weight"
                      class="form-control"
                      type="number"
              ...
              <div class="row">
                <div class="col-12 col-sm-4">
                  <label>Mother Tag No.</label>
                  <input
                      v-model="viewing_sale.mother_tagNo"
                      class="form-control"
                      type="text"
                ...
                <div class="col-12 col-sm-4">
                  <label>Father Tag No.</label>
                  <input
                      v-model="viewing_sale.father_tagNo"
                      class="form-control"
                      type="text"
                ...
                <div class="col-12 col-sm-4">
                  <label>Mother Breed</label><br>
                  <select   v-model="viewing_sale.mother_breed"  >
                    <option>Large White</option>
                    <option>Landrance</option>
                    <option>Duroc</option>
                    <option>Local</option>
                ...
                <div class="col-12 col-sm-4">
                  <label>Father Breed</label><br>
                  <select    v-model="viewing_sale.father_breed" >
                    <option>Large White</option>
                    <option>Landrance</option>
                    <option>Duroc</option>
                    <option>Local</option>
                ...
                <div class="col-12 col-sm-4">
                  <label>Date of conception</label>
                  <input
                      v-model="viewing_sale.date_of_conception"
                      class="form-control"
                      type="date"
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <textarea class="form-control" type="text"
                            ...
                            v-model="viewing_sale.parents_description"
                  />
                </div>
