  ...
  <div class="py-4 container-fluid">
    ...
    <div class="mt-4 row container-fluid" v-if="fcp_age_groups">
      ...
      <div class="col-sm-8  mt-lg-0 container-fluid" >
        <div class="card">
          <div class="card-body">
            <h5 class="font-weight-bolder">New pig</h5>
            <div class="row">
      ...
      <div class="mt-4  mt-lg-0" >
        ...
        <div class="card">
          <div class="card-body">
            ...
            <h5 class="font-weight-bolder">My pigs</h5><br>
      ...
      <div  class="modal-dialog modal-lg modal-dialog-scrollable">
        ...
        <div class="modal-content" >
          <div class="card" >
            ...
            <div class="card-body">
              <h5 class="font-weight-bolder">Viewing pig</h5>
              <div class="row">
                <div class="col-12 col-sm-4">
                  <label>Tag No.</label>
                  <input
                      v-model="viewing_pig.tagNo"
                      class="form-control"
                      type="text"
                ...
                <div class="col-12 col-sm-4">
                  <label>Breed</label><br>
                  <select   v-model="viewing_pig.breed"  >
                    <option>Large white</option>
                    <option>Landrance</option>
                    <option>Duroc</option>
                    <option>Local</option>
                ...
                <div class="col-12 col-sm-4">
                  <label>Description</label>
                  <textarea class="form-control" type="text"
                            v-model="viewing_pig.description"
                ...
                <div class="col-12 col-sm-3">
                  <label class="mt-4">Color</label><br>
                  <select    v-model="viewing_pig.pig_color" >
                    <option>White</option>
                    <option>Brown</option>
                    <option>Black</option>
                    <option>Brown and black</option>
                ...
                <div class="col-3">
                  <label class="mt-4">Weight(KG)</label>
                  <input class="form-control" type="number"   v-model="viewing_pig.weight" />
                </div>
                <div class="col-12 col-sm-3">
                  <label class="mt-4">Origin</label><br>
                  <select    v-model="viewing_pig.origin" >
                    <option>In-house</option>
                    <option>Purchased</option>
                  </select>
                </div>
                ...
                <div class="col-3">
                  <label class="mt-4">Date of birth</label>
                  <input class="form-control" type="date"   v-model="viewing_pig.dob" />
                </div>
              ...
              <div class="row">
                <div class="col-12 col-sm-4">
                  <label>Mother Tag No.</label>
                  <input
                      v-model="viewing_pig.mother_tagNo"
                      class="form-control"
                      type="text"
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <input
                      v-model="viewing_pig.father_tagNo"
                      class="form-control"
                      type="text"
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <select   v-model="viewing_pig.mother_breed"  >
                    <option>Large White</option>
                    <option>Landrance</option>
                    <option>Duroc</option>
                    <option>Local</option>
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <select    v-model="viewing_pig.father_breed" >
                    <option>Large White</option>
                    <option>Landrance</option>
                    <option>Duroc</option>
                    <option>Local</option>
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <input
                      v-model="viewing_pig.date_of_conception"
                      class="form-control"
                      type="date"
                ...
                <div class="col-12 col-sm-4">
                  ...
                  <textarea class="form-control" type="text"
                            ...
                            v-model="viewing_pig.parents_description"
                  />
                </div>
